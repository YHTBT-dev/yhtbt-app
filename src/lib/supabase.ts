...
// reflectionsStore.js's "reflections" table). Set to public read so
// <img src> and downloads work without signed URLs — fine for now since
// there's no auth/private-Experience concept yet, same as everything
// else in this app.
